...
class Wp3DEngine {
    ...
    public function mark_message_as_read() {
        ...
        if(is_wp_error($user_id)){
            ...
            wp_send_json_success([ 'message' => '¡Listo! Los primeros capítulos gratuitos ya están en tu correo.'  ]);
        }
        // $this->sendEmail();
    }
